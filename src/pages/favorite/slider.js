...
const Example = (props) => {
  ...
  if (props.items) {
    ...
    let slides = props.items.map((item) => {
      return (
        <CarouselItem
        ...
        >
          ...
          <img src='https://www.ziko.by/upload/resize_cache/iblock/008/220_200_1/0082c691ce44a9338e331e518e1228d7.png' alt={item.altText} />
...
let top = (st) => {
  let Clone = st.filter(function (item) {
...
export default connect(setStateToProps)(Example);